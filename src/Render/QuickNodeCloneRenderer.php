...
/**
 * @file
 * Contains \Drupal\quick_node_clone\Render\QuickNodeCloneRenderer.
 */

namespace Drupal\quick_node_clone\Render;

use Drupal\quick_node_clone\Theme\QuickNodeCloneThemeManager;
 ...
 */
class QuickNodeCloneRenderer extends Renderer {
   ...
   */
  public function __construct(ControllerResolverInterface $controller_resolver, QuickNodeCloneThemeManager $theme, ElementInfoManagerInterface $element_info, PlaceholderGeneratorInterface $placeholder_generator, RenderCacheInterface $render_cache, RequestStack $request_stack, array $renderer_config) {
  ...
  protected function doRender(&$elements, $is_root_call = FALSE) {
    ...
    $children = QuickNodeCloneElement::children($elements, TRUE);
